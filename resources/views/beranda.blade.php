...
<body>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            <a href="https://flowbite.com" class="flex items-center space-x-3 rtl:space-x-reverse" data-aos="fade-right">
                <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
            </a>
            <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
                <a href="#" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800" data-aos="fade-left">Login</a>
                <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" data-aos="fade-left">Sign up</a>
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    ...
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" data-aos="fade-down">Team</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="relative bg-gray-700 bg-blend-multiply min-h-[350px] sm:min-h-[450px] md:min-h-[550px] lg:min-h-[650px] flex items-center" data-aos="fade-down">
        ...
        <div class="relative px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 z-10 flex flex-col items-center justify-center w-full">
            <a data-aos="fade-down" href="#" class="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
                <span data-aos="fade-down" class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 me-3">New</span> <span class="text-sm font-medium">Jumbotron component was launched! See what's new</span> 
            ...
            <h1 data-aos="fade-up" class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                Kami Melayani Masyarakat <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Desa Tarum</span>
            </h1>
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a data-aos="fade-right" href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Get started
    ...
    <div class="p-6 bg-gray-50 dark:bg-gray-900">
        ...
        <section class="bg-gray-50 dark:bg-gray-900 py-10" id="profil-desa">
            <div class="max-w-screen-xl mx-auto px-4 lg:px-6">
                ...
                <!-- Kartu Profil Desa (Kiri) -->
                <div data-aos="fade-right">
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <img class="rounded-t-lg" src="https://assets-a1.kompasiana.com/items/album/2023/07/25/picsart-23-07-24-09-29-47-719-64bf89274addee6f532a9e94.jpg" alt="Foto Desa" />
                    <div class="p-5">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Profil Desa Tarum</h5>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    Tarum adalah sebuah desa di Kecamatan Prajekan, Kabupaten Bondowoso, Provinsi Jawa Timur.
                        </p>
                        <a href="#tentang-kami" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800">
                        Tentang Kami
                ...
                <!-- Highlighted Heading dan Fitur Layanan (Kanan) -->
                <div data-aos="fade-left">
                    ...
                    <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                        <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Layanan</mark> <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Masyarakat</span>
                    </h1>
                    ...
                    <li class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pembuatan Surat Keterangan</span>
                    </li>
                    <li class="flex items-center space-x-3 rtl:space-x-reverse">
                        <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm4.707-9.707a1 1 0 00-1.414-1.414L9 11.586 6.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l5-5z" clip-rule="evenodd" />
                        </svg>
                        <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Administrasi Kependudukan</span>
                    </li>
                    <li class="flex items-center space-x-3 rtl:space-x-reverse">
                        <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm4.707-9.707a1 1 0 00-1.414-1.414L9 11.586 6.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l5-5z" clip-rule="evenodd" />
                        </svg>
                        <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pendaftaran Bantuan Sosial</span>
                    </li>
                    <li class="flex items-center space-x-3 rtl:space-x-reverse">
                        <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm4.707-9.707a1 1 0 00-1.414-1.414L9 11.586 6.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l5-5z" clip-rule="evenodd" />
                        </svg>
                        <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Informasi UMKM dan Potensi Lokal</span>
                    </li>
                    </ul>
                </div>
                ...
                <div data-aos="fade-right">
                    <div class="mb-4">
                        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Sejarah <span class="text-blue-500 dark:text-blue-400"> Desa</span> <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Tarum.</span></h1>
                        <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Pada awalnya, wilayah Desa Tarum merupakan hutan belantara yang membentang dari utara ke selatan, terdiri dari dataran rendah dan tinggi. Pembukaan lahan dilakukan oleh para pendatang dari Pulau Madura dengan tujuan utama berdagang. Beberapa tokoh leluhur yang dikenal dalam proses ini antara lain Buyut Mursyid, Buyut Sipi, Buyut Amar, Buyut Beraji, Buyut Mohammad, Buyut Raji'in, dan Buyut Cuwet. Nama "Tarum" diambil dari tanaman perdu tarum yang banyak ditemui oleh para sesepuh saat pembabatan hutan.</p>
                    </div>
                </div>
                <div data-aos="fade-left">
                    <div class="mb-4">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.2484943610516!2d113.9967657!3d-7.7967777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd6d7ab09485b87%3A0xca5b7fb2f8269b66!2sTarum%2C%20Kec.%20Prajekan%2C%20Kabupaten%20Bondowoso%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1716460971293!5m2!1sid!2sid" 
                        width="100%" 
                        height="450" 
                        style="border:0;" 
                        allowfullscreen="" 
