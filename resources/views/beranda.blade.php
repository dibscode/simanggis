...
<body>
                ...
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                    <li>
                        <a href="#"
                            ...
                            aria-current="page" data-aos="fade-down">Home</a>
                    </li>
                    <li>
                        <button data-aos="fade-down" id="mega-menu-icons-dropdown-button"
    ...
    <section
        class="relative bg-gray-700 bg-blend-multiply min-h-[350px] sm:min-h-[450px] md:min-h-[550px] lg:min-h-[650px] flex items-center"
        data-aos="fade-down">
        ...
        <div class="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0 flex justify-center">
            <div class="relative w-full h-full max-w-full">
                <video src="{{ asset('/storage/food.mp4') }}" autoplay muted loop playsinline
        ...
        <div
            ...
            <a data-aos="fade-down" href="#"
                ...
                <span data-aos="fade-down"
                    ...
                    class="text-sm font-medium">Statistik Sekolah Terbaru</span>
            ...
            <h1 data-aos="fade-up"
                ...
                Sistem Monitoring <span
                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Makan
                    Grtais</span>
            </h1>
            <p data-aos="fade-up" class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
                Website Resmi Desa Tarum – Mewujudkan Pelayanan Publik yang Transparan, Cepat, dan Responsif untuk
                Masyarakat.
            </p>
                    ...
                    <div data-aos="fade-right">
                        <div
                            ...
                            <img class="rounded-t-lg"
                                src="https://assets-a1.kompasiana.com/items/album/2023/07/25/picsart-23-07-24-09-29-47-719-64bf89274addee6f532a9e94.jpg"
                                alt="Foto Desa" />
                            <div class="p-5">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Profil
                                    Desa Tarum</h5>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                    Tarum adalah sebuah desa di Kecamatan Prajekan, Kabupaten Bondowoso, Provinsi Jawa
                                    Timur.
                                </p>
                                <a href="#tentang-kami"
                    ...
                    <div data-aos="fade-left">
                        <div class="mb-4">
                            <h1
                                ...
                                <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Layanan</mark> <span
                                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Masyarakat</span>
                            </h1>
                            <p class="mt-4 text-gray-700 dark:text-gray-300">
                                Kami menyediakan berbagai layanan untuk mendukung kebutuhan warga desa dengan cepat dan
                                mudah.
                            </p>
                        </div>
                        ...
                        <ul class="space-y-4 text-left text-gray-500 dark:text-gray-400">
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pembuatan Surat
                                    Keterangan</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Administrasi
                                    Kependudukan</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pendaftaran
                                    Bantuan Sosial</span>
                            </li>
                            <li class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor"
                                ...
                                <span class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Informasi UMKM
                                    dan Potensi Lokal</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div data-aos="fade-right">
                        <div class="mb-4">
                            <h1
                                ...
                                Sejarah <span class="text-blue-500 dark:text-blue-400"> Desa</span> <span
                                    class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Tarum.</span>
                            </h1>
                            <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Pada awalnya,
                                wilayah Desa Tarum merupakan hutan belantara yang membentang dari utara ke selatan,
                                terdiri dari dataran rendah dan tinggi. Pembukaan lahan dilakukan oleh para pendatang
                                dari Pulau Madura dengan tujuan utama berdagang. Beberapa tokoh leluhur yang dikenal
                                dalam proses ini antara lain Buyut Mursyid, Buyut Sipi, Buyut Amar, Buyut Beraji, Buyut
                                Mohammad, Buyut Raji'in, dan Buyut Cuwet. Nama "Tarum" diambil dari tanaman perdu tarum
                                yang banyak ditemui oleh para sesepuh saat pembabatan hutan.</p>
                        </div>
                    </div>
                    <div data-aos="fade-left">
                        <div class="mb-4">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.2484943610516!2d113.9967657!3d-7.7967777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd6d7ab09485b87%3A0xca5b7fb2f8269b66!2sTarum%2C%20Kec.%20Prajekan%2C%20Kabupaten%20Bondowoso%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1716460971293!5m2!1sid!2sid"
