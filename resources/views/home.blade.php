    ...
    <nav class="bg-white border-gray-200">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            <a href="https://flowbite.com" class="flex items-center space-x-3 rtl:space-x-reverse" data-aos="fade-right">
                <img src="{{ asset('/storage/logo-icon-white.png') }}" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap">SIMANGGIS</span>
            </a>
            ...
            <div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                    <li>
                        <a href="#" class="block py-2 px-3 text-blue-600 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 md:dark:hover:text-blue-500 md:dark:hover:bg-transparent" aria-current="page" data-aos="fade-down">Home</a>
                    </li>
                    <li>
                                ...
                                <ul class="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
                                    <li>
                                        <a href="#" class="flex items-center text-gray-500 hover:text-blue-600 group">
                                            ...
                                            <svg class="w-3 h-3 me-2 text-gray-400 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <li>
                                        <a href="#" class="flex items-center text-gray-500 hover:text-blue-600 group">
                                            ...
                                            <svg class="w-3 h-3 me-2 text-gray-400 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                                ...
                                <ul class="space-y-4">
                                    ...
                                    <li>
                                        <a href="#" class="flex items-center text-gray-500 hover:text-blue-600 group">
                                            ...
                                            <svg class="w-3 h-3 me-2 text-gray-400 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 20">
                                ...
                                <ul class="space-y-4">
                                    ...
                                    <li>
                                        <a href="#" class="flex items-center text-gray-500 hover:text-blue-600 group">
                                            ...
                                            <svg class="w-3 h-3 me-2 text-gray-400 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 21">
                                    ...
                                    <li>
                                        <a href="#" class="flex items-center text-gray-500 hover:text-blue-600 group">
                                            ...
                                            <svg class="w-3 h-3 me-2 text-gray-400 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                    ...
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 md:dark:hover:text-blue-500 md:dark:hover:bg-transparent" data-aos="fade-down">Team</a>
                    </li>
                </ul>
            </div>
        </div>
