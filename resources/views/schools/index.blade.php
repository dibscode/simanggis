         ...
         <aside class="w-64 bg-white shadow-md hidden md:block">
            ...
            <nav class="p-4">
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('school.data') }}" class="block px-4 py-2 rounded bg-blue-600 text-white">Data Sekolah</a></li>
                    <li><a href="{{ route('class') }}" class="block px-4 py-2 rounded hover:bg-blue-100">Daftar Kelas</a></li>
                    <li><a href="{{ route('teachers') }}" class="block px-4 py-2 rounded hover:bg-blue-100">Daftar Guru</a></li>
