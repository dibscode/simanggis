            ...
            <tbody>
                @foreach ($classes as $class)
                    ...
                    <tr>
                        ...
                        <td class="w-56 px-4 py-2 border">{{ $class->class_name ?? '-' }}</td>
                        ...
                        <td class="w-32 px-2 py-2 border">
                            <div class="flex justify-center gap-2">
                                <div class="flex flex-col items-center">
                                    <a href="{{ route('class.detail', $class->class_id ?? '') }}" class="flex flex-col items-center text-green-600 hover:underline">
                                        <!-- Detail Icon -->
                                ...
                                <div class="flex flex-col items-center">
                                    <a href="{{ route('class.edit', $class->class_id ?? '') }}" class="flex flex-col items-center text-blue-600 hover:underline">
                                        <!-- Edit Icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="flex flex-col items-center">
                                    <form action="{{ route('class.delete', $class->class_id ?? '') }}" method="POST" onsubmit="return confirm('Yakin hapus data ini?');" class="flex flex-col items-center">
                                        @csrf
                                        @method('DELETE')
                                        <!-- Delete Icon -->
